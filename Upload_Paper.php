...
if (! empty($_SESSION['logged_in']))
{
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["name"])) {
    ...
    ?>
            <div id="upload_paper" class="upload_paper">
                 <h1>UPLOAD QUESTION PAPER</h1><br>
              <form action="db_upload_paper.php" enctype="multipart/form-data" method="post">
  <select name="branch">
...
<input type="text" name="namepaper" size="40" placeholder="Enter Subject Name"><br>
                  <span class="error">*<?php echo $nameErr;?></span><br> <br>
<input type="file" name="fileupload" value="fileupload" id="paperupload"> <br><br>
