...
if (! empty($_SESSION['logged_in']))
{
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["name"])) {
    ...
    ?>
<div id="upload_notice" class="upload_notice">
                 <h1>UPLOAD NOTICE</h1><br>
              <form action="db_upload_notice.php" enctype="multipart/form-data" method="post">
  <select name="type">
  <option value="None">--Notice Type--</option>
...
<input type="text" name="name" size="40" placeholder="Enter Title For Notice"><br>
                  <span class="error">*<?php echo $nameErr;?></span><br> <br>
<input type="file" name="fileupload" value="fileupload" id="noticeupload"><br><br>
