...
if (! empty($_SESSION['logged_in']))
{
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (empty($_POST["name"])) {
    ...
    ?>
<div id="upload_book" class="upload_book">
                 <h1>UPLOAD BOOK</h1><br>
              <form action="db_upload_book.php" enctype="multipart/form-data" method="post">
  <select name="branch">
...
<input type="text" name="namebook" size="40" placeholder="Enter Name of Book And Subject"><br>
                  <span class="error">*<?php echo $nameErr;?></span><br> <br>
<input type="file" name="fileupload" value="fileupload" id="bookupload"> <br><br>
